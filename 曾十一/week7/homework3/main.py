...
def mian():
    ...
    with open('/mnt/data_1/zfy/4/week7/homework/homework3/comments.pkl','rb') as f:
    ...
    train_data, val_data, test_data = random_split(comments_data, [train_size, val_size, test_size])

    batch_size = 64 
    train_loader = DataLoader(train_data, batch_size=batch_size, shuffle=True, collate_fn=convert_data)
    val_loader = DataLoader(val_data, batch_size=batch_size, shuffle=True, collate_fn=convert_data)
    test_loader = DataLoader(test_data, batch_size=batch_size, shuffle=True, collate_fn=convert_data)
