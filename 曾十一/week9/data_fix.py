...
if __name__ == '__main__':
    ...
    # 训练数据
    enc_train_file = '/mnt/data_1/zfy/self/homework/kagglehub/datasets/jiaminggogogo/chinese-couplets/versions/2/couplet/train/in.txt'
    dec_train_file = '/mnt/data_1/zfy/self/homework/kagglehub/datasets/jiaminggogogo/chinese-couplets/versions/2/couplet/train/out.txt'
    ...
    # 数据整体json数据集（json）
    with open('/mnt/data_1/zfy/self/homework/encoder.json', 'w', encoding='utf-8') as f:
        json.dump(enc_data, f)  
    
    with open('/mnt/data_1/zfy/self/homework/decoder.json', 'w', encoding='utf-8') as f:
