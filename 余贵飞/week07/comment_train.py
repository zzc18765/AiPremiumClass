...
from classifier_model import CommentsClassifier
from 余贵飞.week07.corpus_proc import build_collate_func, build_vocab_from_documents
...
if __name__ == '__main__':
    ...
    # 使用默认才分率
    (x_valid,y_valid), (x_test, y_test) = train_test_split(x_test, y_test)
