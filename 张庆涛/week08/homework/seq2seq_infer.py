...
if __name__ == '__main__':
    # 加载训练好的模型和词典
    enc_test_file = '../data/couplet/test/in.txt'
    dec_test_file = '../data/couplet/test/out.txt'
    # 获取数据
    enc_data,dec_data = read_data(enc_test_file, dec_test_file)

    # 加载训练好的的模型和字典week8/data/couplet/seq2seq_state.bin
    # state_dict = torch.load('../data/couplet/seq2seq_state.bin')
    state_dict = torch.load('../data/couplet/seq2seq_state_add.bin')
