...
class Encoder(nn.Module):
    def __init__(self, input_dim, emb_dim, hidden_dim, dropout,num_layers=2, state_type='concat'):
        super(Encoder, self).__init__()
        # 定义嵌入层
        self.embedding = nn.Embedding(input_dim, emb_dim)
        # 定义GRU层
        self.rnn = nn.GRU(emb_dim, hidden_dim,dropout=dropout, num_layers=num_layers,batch_first=True, bidirectional=True)
...
class Decoder(nn.Module):
    def __init__(self, input_dim, emb_dim, hidden_dim, dropout, state_type='concat'):
...
class Seq2Seq(nn.Module):
    ...
    def __init__(self,
        ...
        # encoder
        self.encoder = Encoder(enc_emb_size, emb_dim, hidden_size, dropout=dropout, state_type=state_type)
        # decoder
        self.decoder = Decoder(dec_emb_size, emb_dim, hidden_size, dropout=dropout, state_type=state_type)


    def forward(self, enc_input, dec_input):
        # encoder last hidden state7
