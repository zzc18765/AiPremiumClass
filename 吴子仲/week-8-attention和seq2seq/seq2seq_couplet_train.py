...
from couplet_process import get_proc
...
if __name__ == "__main__":
    ...
    writer = SummaryWriter("couplet_log")

    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

    # 读取数据
    with open("couplet/encoder.json", "r", encoding="utf-8") as f:
        enc_data = json.load(f)

    with open("couplet/decoder.json", "r", encoding="utf-8") as f:
