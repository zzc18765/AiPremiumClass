...
if __name__ =='__main__':
    ...
    if not os.path.exists('local_save'):
        #加载网页中文本内容，转换langchain'处理的Document
    ...
    #构建检索器
    retriever=vector_store.as_retrieve(search_kwargs={"k":2})

    
    def format_docs(docs):
        return '\n\n'.join([doc.page_conte nt for doc in docs])
